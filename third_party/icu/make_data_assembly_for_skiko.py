...
parser.add_option("--win",
                  ...
                  action="store_true", default=False)
parser.add_option("--mingw",
                  help="generate assembly file for MinGW (default: False)",
                  action="store_true", default=False)
parser.set_usage("""make_data_assembly  icu_data [assembly_file] [--mac] [--win] [--mingw]
...
if options.mac:
  ...
  # MinGW COFF format without underscore prefix for K/N LLVM linker compatibility
